  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[var(--color-line)]/60 bg-[var(--color-base)]/70 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 sm:px-8">
        ...
        <button className="rounded-md border border-[var(--color-line)] px-4 py-1.5 font-mono text-xs text-[var(--color-ink)] transition-colors hover:border-[var(--color-signal)] hover:text-[var(--color-signal)]">
          Launch app
        </button>
      </div>
    </header>
