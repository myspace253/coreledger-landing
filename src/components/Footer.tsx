    ...
    <footer className="mx-auto max-w-6xl px-6 py-28 sm:px-8">
      <div className="reveal rounded-2xl border border-[var(--color-line)] bg-gradient-to-b from-[var(--color-surface)] to-[var(--color-base)] p-10 text-center sm:p-16">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          />
          <button className="w-full rounded-lg bg-[var(--color-signal)] px-6 py-3 font-display text-sm font-semibold text-[var(--color-base)] transition-transform hover:scale-[1.02] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-signal)] sm:w-auto">
            Generate report
          </button>
        </div>
      </div>
